...
- Status: verified on 2026-09-10 (`implemented`), including native 130XE 128K memory expansion.
...
- Issues: disassembly mode (F12, when enabled) is one-way until emulator restart. Only the 130XE 128K profile is implemented; RAMBO and COMPY profiles remain pending.
